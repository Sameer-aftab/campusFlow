...
export const studentSchema = z.object({
  ...
  classStudying: z.enum(['6', '7', '8', '9', '10'], { required_error: 'Class is required' }),
  section: z.enum(['A', 'B', 'C', 'D', 'E', 'F', 'G', 'CADET'], { required_error: 'Section is required' }),
  ...
  reasonOfLeaving: z.string().optional().default(''),
  examination: z.enum(['Class 6', 'Class 7', 'Class 8', 'S.S.C Part-I Annual', 'S.S.C Part-II Annual']).optional(),
  underSeatNo: z.string().optional().default(''),
  ...
  sscRollNo: z.string().optional().default(''),
});
